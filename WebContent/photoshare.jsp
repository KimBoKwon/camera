<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="com.bokwon.dto.PhotoShareDto"%>
<%@page import="java.util.ArrayList"%>
<%
	ArrayList<PhotoShareDto> list = (ArrayList<PhotoShareDto>)request.getAttribute("PhotoShareList");
	int  i = 0;
%>
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <table class="table table-dark table-striped">
                ...
                <tbody>
                	<%
						for (PhotoShareDto wr : list) {%>
							<tr onclick="modal_show('<%=wr.getPhotoresize()%>')">
								<td><%=wr.getNum()%></td>
								<td><%=wr.getCamera()%></td>
								<td><%=wr.getLens()%></td>
								<td><%=wr.getWriter()%></td>
		    ...
		    <div class="modal-dialog">
		      <div class="modal-content" style="width: 820px; height: 780px;">
	...
	<p>원하는 게시물을 선택하면 사진을 보실수 있습니다!</p>
	<a href="photosharewrite.nhn" class="btn btn-primary pull-right">글쓰기</a>
        </div>
    </div>
  ...
  <script>
    ...
    function modal_show (imgsrc) {
//    	alert("<img src='" + imgsrc +" '");
	$("#myModal").modal("show");
// 	var hugi = $("#photo" + num).val();
	$("#img_view").html("<img src='" + imgsrc +" '>");
