        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/canon200d2.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Canon Eos 200D 2</a>
                </h4>
                <h5>약 67만원</h5>
                <p class="card-text">유효화소수 : 2420만화소</p>
                <p class="card-text">ISO : 100~25600</p>
                <p class="card-text">최소 셔터 스피트 : 8000초</p>
                <p class="card-text">부가기능 : 렌즈수차보정</p>
                <p class="card-text">동영상  해상도 : UHD(4K)</p>
                <p class="card-text">초점 영역 : 9개</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/canon200d.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Canon Eos 200d</a>
                </h4>
                <h5>약 46만원</h5>
                <p class="card-text">유효화소수 : 2420만화소</p>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/canon100d.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Canon Eos 100D</a>
                </h4>
                <h5>약 22만원</h5>
                ...
                <p class="card-text">최소 셔터 스피트 : 4000초</p>
                <p class="card-text">동영상  해상도 : Full-HD</p>
                <p class="card-text">부가기능 : 렌즈수차보정, 벌브지원</p>
                <p class="card-text">초점 영역 : 9개</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/canon80d.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Canon Eos 80D</a>
                </h4>
                <h5>약 63만원</h5>
                <p class="card-text">유효화소수 : 2420만화소</p>
                <p class="card-text">ISO : 100~12800</p>
                <p class="card-text">최소 셔터 스피트 : 8000초</p>
                <p class="card-text">동영상  해상도 : Full-HD</p>
                <p class="card-text">부가기능 : 렌즈수차보정, 손떨림방지, 무선전송</p>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/canon70d.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Canon Eos 70D</a>
                </h4>
                <h5>약 40만원</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/canon700d.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Canon Eos 700D</a>
                </h4>
                <h5>약 23만원</h5>
                <p class="card-text">유효화소수 : 1800만화소</p>
                ...
                <p class="card-text">최소 셔터 스피트 : 4000초</p>
                <p class="card-text">동영상  해상도 : Full-HD</p>
                <p class="card-text">부가기능 : 렌즈수차보정, 벌브지원, 리사이즈</p>
                <p class="card-text">초점 영역 : 9개</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/canon650d.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Canon Eos 650D</a>
                </h4>
                <h5>약 20만원</h5>
                <p class="card-text">유효화소수 : 1800만화소</p>
                <p class="card-text">ISO : 100~12800</p>
                <p class="card-text">최소 셔터 스피트 : 4000초</p>
                <p class="card-text">동영상  해상도 : Full-HD</p>
                <p class="card-text">부가기능 : 얼굴인식, 벌브지원, 리사이즈, 주변광량보정</p>
                <p class="card-text">초점 영역 : 9개</p>
              </div>
            </div>
          </div>
