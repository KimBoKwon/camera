...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="container-fluid">
        <div class="container">
			<div class="row">
				<form method="post" action="camerahugiwriteok.nhn">
					<table class="table table-striped"
						...
						<tbody>
							...
							<tr>
								<td>
									<textarea class="form-control" placeholder="리뷰 내용"
										name="content" id="content" maxlength="2048" style="height: 350px;">
									</textarea>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td>
									<a>점수</a>
									<select id="score" name="score" class="custom-select"
