        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/d6.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Nikon D6</a>
                </h4>
                <h5>약 798만원</h5>
                <p class="card-text">유효화소수 : 2082만화소</p>
                <p class="card-text">ISO : 100~102400</p>
                <p class="card-text">최소 셔터 스피트 : 8000초</p>
                <p class="card-text">동영상  해상도 : UHD(4K)</p>
                <p class="card-text">초점 영역 : 105개</p>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/d5.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Nikon D5</a>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/d850.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Nikon D850</a>
                </h4>
                <h5>약 271만원</h5>
                <p class="card-text">유효화소수 : 4575만화소</p>
                <p class="card-text">ISO : 64~25600</p>
                <p class="card-text">최소 셔터 스피트 : 8000초</p>
                <p class="card-text">동영상  해상도 : UHD(4K)</p>
                <p class="card-text">초점 영역 : 153개</p>
                <p class="card-text">무게 : 1kg</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/d810.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Nikon D810</a>
                </h4>
                <h5>약 73만원</h5>
                <p class="card-text">유효화소수 : 3635만화소</p>
                <p class="card-text">ISO : 64~12800</p>
                <p class="card-text">최소 셔터 스피트 : 8000초</p>
                <p class="card-text">동영상  해상도 : Full-HD</p>
                <p class="card-text">초점 영역 : 51개</p>
                <p class="card-text">무게 : 980g</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/d780.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Nikon D780</a>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/d750.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Nikon D750</a>
                </h4>
