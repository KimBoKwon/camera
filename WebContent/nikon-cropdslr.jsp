        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/d500.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Nikon D500</a>
                </h4>
                <h5>약 131만원</h5>
                <p class="card-text">유효화소수 : 2088만화소</p>
                <p class="card-text">ISO : 100~51200</p>
                <p class="card-text">최소 셔터 스피트 : 8000초</p>
                <p class="card-text">동영상  해상도 : UHD(4K)</p>
                <p class="card-text">초점 영역 : 153개</p>
                <p class="card-text">무게 : 860g</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/d7500.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Nikon D7500</a>
                </h4>
                <h5>약 79만원</h5>
                <p class="card-text">유효화소수 : 2088만화소</p>
                <p class="card-text">ISO : 100~51200</p>
                <p class="card-text">최소 셔터 스피트 : 8000초</p>
                <p class="card-text">동영상  해상도 : UHD(4K)</p>
                <p class="card-text">초점 영역 : 51개</p>
                <p class="card-text">무게 : 640g</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/d7200.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Nikon D7200</a>
                </h4>
                <h5>약 45만원</h5>
                <p class="card-text">유효화소수 : 2416만화소</p>
                <p class="card-text">ISO : 100~25600</p>
                <p class="card-text">최소 셔터 스피트 : 8000초</p>
                <p class="card-text">동영상  해상도 : Full-HD</p>
                <p class="card-text">초점 영역 : 51개</p>
                <p class="card-text">무게 : 765g</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/d5600.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Nikon D5600</a>
                </h4>
                <h5>약 46만원</h5>
                <p class="card-text">유효화소수 : 2416만화소</p>
                <p class="card-text">ISO : 100~25600</p>
                ...
                <p class="card-text">동영상  해상도 : Full-HD</p>
                <p class="card-text">초점 영역 : 39개</p>
                <p class="card-text">무게 : 465g</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/d3500.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Nikon D3500</a>
                </h4>
                <h5>약 45만원</h5>
                <p class="card-text">유효화소수 : 2416만화소</p>
                <p class="card-text">ISO : 100~25600</p>
                <p class="card-text">최소 셔터 스피트 : 4000초</p>
                <p class="card-text">동영상  해상도 : Full-HD</p>
                <p class="card-text">초점 영역 : 11개</p>
                <p class="card-text">무게 : 415g</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/d3400.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Nikon D3400</a>
                </h4>
                <h5>약 32만원</h5>
                <p class="card-text">유효화소수 : 2416만화소</p>
