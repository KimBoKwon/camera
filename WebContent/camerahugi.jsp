...
<%
	ArrayList<CameraHugiDto> list = (ArrayList<CameraHugiDto>)request.getAttribute("CameraHugiList");
	int  i = 0;
%>
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <div class="d-flex" id="wrapper">
	...
	<a href="camerahugiwrite.nhn" class="btn btn-primary pull-right">글쓰기</a>
        </div>
    </div>
