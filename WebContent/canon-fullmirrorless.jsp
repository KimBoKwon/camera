        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/canonR5.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Canon Eos R5</a>
                </h4>
                <h5>약 520만원</h5>
                <p class="card-text">유효화소수 : 4500만화소</p>
                <p class="card-text">ISO : 100~51200</p>
                <p class="card-text">최소 셔터 스피트 : 8000초</p>
                <p class="card-text">부가기능 : 렌즈수차보정</p>
                <p class="card-text">동영상  해상도 : 8K</p>
                <p class="card-text">초점 영역 : 1053개</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/canonR6.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Canon Eos R6</a>
                </h4>
                <h5>약 320만원</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/canonR.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Canon Eos R</a>
                </h4>
                <h5>약 240만원</h5>
                <p class="card-text">유효화소수 : 3030만화소</p>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/canonRP.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Canon Eos RP</a>
                </h4>
                <h5>약 145만원</h5>
                ...
                <p class="card-text">최소 셔터 스피트 : 4000초</p>
                <p class="card-text">동영상  해상도 : UHD(4K)</p>
                <p class="card-text">초점 영역 : 4779개</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="assets/img/canonRa.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Canon Eos Ra</a>
                </h4>
                <h5>약 330만원</h5>
                <p class="card-text">유효화소수 : 3030만화소</p>
                <p class="card-text">ISO : 100~40000</p>
