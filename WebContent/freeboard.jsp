<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="com.bokwon.dto.FreeBoardDto"%>
<%@page import="java.util.ArrayList"%>
<%
	ArrayList<FreeBoardDto> list = (ArrayList<FreeBoardDto>)request.getAttribute("FreeBoardList");
	int  i = 0;
%>
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <div class="d-flex" id="wrapper">
	...
	<a href="freeboardwrite.nhn" class="btn btn-primary pull-right">글쓰기</a>
        </div>
    </div>
